 ...
 * @author isaac
 */
public class EjemploSeparator extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EjemploSeparator.class.getName());

    /**
     * Creates new form EjemploSeparator
     */
    public EjemploSeparator() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new EjemploSeparator().setVisible(true));
    }
